...
import com.brainburst.presentation.ads.NativeAdCard

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun LeaderboardScreen(viewModel: LeaderboardViewModel, adManager: com.brainburst.domain.ads.AdManager) {
            ...
            uiState.errorMessage != null -> {
                ...
                Column(
                    ...
                    LazyColumn(
                        ...
                        val entries = uiState.entries.take(50)
                        itemsIndexed(entries) { index, entry ->
                            // Show native ad every 5 entries (after entries 4, 9, 14, etc.)
